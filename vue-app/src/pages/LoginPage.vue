<template>
  <div class="w-full max-w-md mx-auto bg-white border-t-4 border-t-[#015C91] rounded-2xl border border-slate-200/50 shadow-xl shadow-slate-200/60 p-8 sm:p-10 transition-all duration-300 hover:shadow-2xl hover:shadow-slate-200/80">
    ...
    <h1 class="text-2xl font-semibold text-slate-800 mb-1">Entrar</h1>
    <p class="text-slate-600 mb-6">Acesse sua conta para continuar.</p>
    ...
    <form @submit.prevent="onSubmit" class="space-y-5">
      ...
      <p class="text-xs text-slate-500 text-center mt-6">
        Não tem uma conta?
        <router-link to="/cadastro" class="font-semibold text-[#015C91] hover:text-[#014d7a] hover:underline transition-colors ml-1">
          Cadastre-se
        </router-link>
      </p>
    </form>
